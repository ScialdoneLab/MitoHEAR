...
Existing packages [@Huang2021, @Prashant2020, @Calabrese2014]] focus only on the first step of quantifying heteroplasmy from BAM files. However, they do not provide any specific tools for further statistical analyses or plotting.
