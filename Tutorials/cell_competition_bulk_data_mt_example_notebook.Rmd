...
Finally we observe that the 98% of the top 50 bases defined in a unsupervised way (Wilcoxon test) are also bases that are different from the BL6 reference genome in the two cell lines. This reveals the high consistency of the analysis performed by MitoHEAR. 
```{r}
