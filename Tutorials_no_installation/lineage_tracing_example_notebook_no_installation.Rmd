...
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","meta_data_antonio_final.Rda"))
...
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","output_SNP_antonio_mt.Rda"))
...
The VI between random partitions (obtained wth re-shuflle from original labels in ground truth) and ground truth is also computed.
