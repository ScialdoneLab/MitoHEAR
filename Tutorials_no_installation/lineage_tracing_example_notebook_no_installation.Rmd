...
load(paste0(your_path,"/MitoHEAR-master/data/","meta_data_antonio_final.rda"))
#data("meta_data_antonio_final",package="MitoHEAR")
...
load(paste0(your_path,"/MitoHEAR-master/data/","output_SNP_antonio_mt.rda"))
#data("output_SNP_antonio_mt",package="MitoHEAR")
...
MitoHEAR offers the possibility to perform a hierarchical clustering on the cells based on a distance matrix with the function *clustering_dist_ang*. Given a base, the distance between two cells is the angular distance of the allele frequencies. In this way we can represent the difference between two cells as a vector whose cordinates are the angular distances of the bases.
