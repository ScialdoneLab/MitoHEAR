...
In this notebook it is shown the heteroplasmy analysis performed on mouse CI-treated epiblast cells from  <https://www.biorxiv.org/content/10.1101/2020.01.15.900613v2>. As a technical control,we focus on heteroplasmy on ERCC-Spike-In.
...
load(paste0(your_path,"/RNAHeteroplasmynew-master/data/","output_SNP_spikes.rda"))
