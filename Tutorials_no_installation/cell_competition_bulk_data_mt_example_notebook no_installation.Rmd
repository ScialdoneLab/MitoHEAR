...
```{r}
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","meta_data_ana_final_big.Rda"))
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","meta_data_ana_final_small.Rda"))
...
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","output_SNP_ana_mt.Rda"))
...
The total distance between two cells is the euclidean norm of the vector of difference between the two cells.
