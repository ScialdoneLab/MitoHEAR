...
```{r}
your_path="/Users/gabriele.lubatti/Desktop/Phd/Heteroplasmy_library_R/Github"
...
Start with dataset GEO accession number GSE115210 from <https://doi.org/10.1016/j.cell.2019.01.022>  used in fig. 2/S2. Individually sorted cells from clonally derived TF1 clones (C9, D6, and G10) were processed with single cell RNA-seq (Smart-seq2)



```{r}

load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","name_cells_fig_2.Rda"))
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","name_cells_fig_2_analysis.Rda"))
...
#setwd("/Users/gabriele.lubatti/Desktop/Phd/Heteroplasmy_library_R/Published_data/fig_2")
#load(file="name_cells_fig_2.Rda")
#load(file="name_cells_fig_2_analysis.Rda")


path_to_bam_fig_2="/nas_storage/gabriele.lubatti/heteroplasmy/published_dataset/all_bam_files/"

bam_input_fig_2=paste(path_to_bam_fig_2,name_cells_fig_2,".unique.bam",sep="")


path_fasta="/nas_storage/gabriele.lubatti/heteroplasmy/published_dataset/Homo_sapiens.GRCh38.dna.chromosome.MT.fa.gz"
```
...
```{r}
#/home/linuxbrew/.linuxbrew/Cellar/r/4.0.2_1/bin/Rscript --vanilla get_raw_counts_allele_script.R -b bam_input_fig_2 -f "/nas_storage/gabriele.lubatti/heteroplasmy/published_dataset/new_human_genome/chrM.fa" -c name_cells_fig_2_analysis -o output_SNP_mt_fig_2_new.Rda -s 8
```

```{r}

load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","output_SNP_mt_fig_2_new.Rda"))
#load(system.file("extdata", "output_SNP_mt_fig_2_new.Rda", package = "MitoHEAR"))

#setwd("/Users/gabriele.lubatti/Desktop/Phd/Heteroplasmy_library_R/Published_data")
#load("output_SNP_mt_fig_2_new.Rda")
...
```{r}
q=list()
for ( i in 1:length(p_value_wilcox_test_sort_small_3)){
p=plot_heteroplasmy(names(p_value_wilcox_test_sort_small_3)[i],heteroplasmy_matrix_ci,cluster_ci,index_ci)+ggtitle(paste(names(p_value_wilcox_test_sort_small_3)[i],round(p_value_wilcox_test_sort_small_3[i],4),sep="-"))
q=list(q,p)
}
q

q=list()
for ( i in names(p_value_wilcox_test_sort_small_3)){
...
result_clustering_sc=clustering_dist_ang(heteroplasmy_matrix_ci,allele_matrix_ci,cluster_ci,length(colnames(heteroplasmy_matrix_ci)),deepSplit_param=1,minClusterSize_param=15,0.2,min_value=0.001,index=index_ci,relevant_bases = features_cluster)
...
result_clustering_sc=clustering_dist_ang(heteroplasmy_matrix_ci,allele_matrix_ci,cluster_ci,length(colnames(heteroplasmy_matrix_ci)),deepSplit_param=1,minClusterSize_param=15,0.2,min_value=0.001,index=index_ci,relevant_bases = NULL)
...
Start with dataset GEO accession number GSE115214 from <https://doi.org/10.1016/j.cell.2019.01.022> used in fig. 5.
...
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","name_cells_fig_5_all.Rda"))
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","name_cells_fig_5_all_analysis.Rda"))
...
#setwd("/Users/gabriele.lubatti/Desktop/Phd/Heteroplasmy_library_R/Published_data")
#load(file="name_cells_fig_5_all.Rda")
#load(file="name_cells_fig_5_all_analysis.Rda")
```
...
path_to_bam_fig_5="/nas_storage/gabriele.lubatti/heteroplasmy/published_dataset/figure_5/aligned_file/sorted_files/"
bam_input_fig_5=paste(path_to_bam_fig_5,name_cells_fig_5_all,".unique.bam",sep="")


```

```{r}
#cell_convert=read.table("/Users/gabriele.lubatti/Desktop/Phd/Heteroplasmy_library_R/Pub#lished_data/CD34_colonies_table.txt",header = T)
#path_meta_data=system.file("extdata", "CD34_colonies_table.txt", package = "MitoHEAR")

path_meta_data=paste0(your_path,"/MitoHEAR-master/inst/extdata/","CD34_colonies_table.txt")
...
```{r}
#/home/linuxbrew/.linuxbrew/Cellar/r/4.0.2_1/bin/Rscript --vanilla get_raw_counts_allele_script.R -b bam_input_fig_5 -f "/nas_storage/gabriele.lubatti/heteroplasmy/published_dataset/new_human_genome/chrM.fa" -c name_cells_fig_5_all_analysis -o output_SNP_mt_fig_5_new.Rda -s 8
```

```{r}
load(paste0(your_path,"/MitoHEAR-master/inst/extdata/","output_SNP_mt_fig_5_new.Rda"))
#path_meta_data=load(system.file("extdata", "output_SNP_mt_fig_5_new.Rda", package = "MitoHEAR"))
#setwd("/Users/gabriele.lubatti/Desktop/Phd/Heteroplasmy_library_R/Published_data")
#load("output_SNP_mt_fig_5_new.Rda")
...
```{r}
q=list()
for ( i in 1:length(p_value_wilcox_test_sort_top)){
p=plot_heteroplasmy(names(p_value_wilcox_test_sort_top)[i],heteroplasmy_matrix_ci,cluster_ci,index_ci)+ggtitle(paste(names(p_value_wilcox_test_sort_top)[i],round(p_value_wilcox_test_sort_small_1[i],4),sep="-"))
q=list(q,p)
}
q
...
q=list()
for ( i in names(p_value_wilcox_test_sort_top)){
p=plot_allele_frequency(i,heteroplasmy_matrix_ci,allele_matrix_ci,cluster_ci,name_position_qc,name_position_allele_qc,5,index_ci)  
q=list(q,p)
}
q
...
```{r}
result_clustering_sc=clustering_dist_ang(heteroplasmy_matrix_ci_small,allele_matrix_ci_small,cluster_ci,length(colnames(heteroplasmy_matrix_ci_small)),deepSplit_param=0,minClusterSize_param=100,0.2,min_value=0.001,index=index_ci,relevant_bases = NULL)
...
```{r}
result_clustering_sc=clustering_dist_ang(heteroplasmy_matrix_ci_small,allele_matrix_ci_small,cluster_ci,length(row.names(heteroplasmy_matrix_ci_small)),deepSplit_param=0,minClusterSize_param=10,0.2,min_value=0.001,index=index_ci,relevant_bases = NULL)
